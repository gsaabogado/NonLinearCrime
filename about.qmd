...
title: ""
description: |
  This website contains all the data and R-code necessary to replicate the results of the study: The Nonlinear Relationship Between Pollution and Crime: Evidence from Mexico City and NewYork forthcomming in Environmental Resarch - Health.
...
2.  ***Descriptive Statistics*** -- contains descriptive statitistics on crime, air pollution, and weather controls. I also divide this section in four sub-sections.
...
-   **02_GenData** -- Contains the set of data.frames I use for the estimation of point estimates. Each data comes from the scientific manipulation of the raw files in the 01_RawFiles repository.
    ...
    -   01_crime: the folder contains three main files: crimes.rds, CrimesCdmx.rds, and CrimesNYC.rds corresponding to data frames of crime observations for the full sample, Mexico City, and New York, respectively
